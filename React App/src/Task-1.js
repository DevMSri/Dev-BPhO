...
const projectileMotion = (theta, u, g, h, dt = 0.01) => {
...
const MainPage = () => {
    ...
    const [initialSpeed, setInitialSpeed] = useState(20.0); // Default to 20 m/s
    const [height, setHeight] = useState(2.0); // Default height
    ...
    const debouncedRecalculate = useCallback(
        debounce((theta, speed, height) => {
            const trajectory = projectileMotion(theta, speed, g, height, dt);
            setData(trajectory);
